...
@NamedQueries({//JPQL(SELECT文)データ nameでつけた名前を引数にすることでデータを呼び出せる
    @NamedQuery(
...
public class Employee {
    ...
    private String code;//すでに存在する社員番号は登録できない旨をデータベースに教えてあげるための設定

    @Column(name = "name", nullable = false)
    private String name;

    @Column(name = "password", length = 64, nullable = false)
    private String password;//length=64と入れることで入力できる文字数が最大64文字にまでなります。
